"use client";
import { Workflow, Plus, Play, CheckCircle, Clock } from "lucide-react";
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-zinc-400 mt-1">Standard operating procedures for your production workflows</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="card p-5">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-xs uppercase tracking-wider text-zinc-400 mb-1 font-medium">In Progress</div>
              <div className="text-2xl font-bold text-white">0</div>
            </div>
      ...
      <div className="card p-8 text-center">
        <Workflow className="h-16 w-16 mx-auto text-zinc-700 mb-4" />
        <h3 className="text-lg font-semibold text-white mb-2">Workflow Templates Coming Soon</h3>
        <p className="text-sm text-zinc-400 mb-4">
          Create SOPs for editing, reviews, social content posting, and deliverable handoffs.
        </p>
        <button className="inline-flex items-center gap-2 rounded-lg border border-purple-500/20 bg-purple-500/10 px-4 py-2.5 text-sm text-purple-300 hover:bg-purple-500/15 transition-colors font-medium">
          <Plus className="h-4 w-4" />
